...
const AboutSection = () => {
  return (
    <section id="about" className="py-24 md:py-32 bg-navy">
      <div className="max-w-7xl mx-auto px-6 md:px-12">
        <div className="grid md:grid-cols-2 gap-16 items-start">
          ...
          <div className="fade-in">
            ...
            <p className="text-ivory/50 font-sans leading-relaxed mb-6">
            ...
            <p className="text-ivory/50 font-sans leading-relaxed mb-10">
            ...
            {/* Prospectus Card */}
            <div className="border border-ivory/10 p-6 flex items-start gap-4">
              <div className="mt-1 text-gold">
                <FileText size={24} strokeWidth={1.5} />
              </div>
              <div>
                <h3 className="font-serif text-ivory text-lg mb-1">Company Prospectus</h3>
                <p className="text-ivory/40 text-sm mb-4">An overview of the company's positioning and strategic direction.</p>
          ...
          <div className="fade-in flex items-center justify-center">
            <div className="w-full aspect-square max-w-md bg-secondary relative overflow-hidden border border-ivory/5">
