    ...
    <footer className="relative bg-navy py-12 border-t border-ivory/5 overflow-hidden">
      ...
      <div className="absolute inset-0 pointer-events-none">
        ...
        <div
          ...
          style={{ backgroundImage: 'repeating-linear-gradient(0deg, transparent, transparent 2px, hsl(var(--gold)) 2px, hsl(var(--gold)) 3px)', backgroundSize: '100% 4px' }} />
      ...
      <div className="relative max-w-[1400px] mx-auto px-6 md:px-12">
        <motion.div
          ...
          <div>
            ...
            <a href="mailto:info@aurumitalia.co.id" className="text-ivory/40 hover:text-gold text-xs font-sans transition-colors duration-300 mt-3 inline-block">info@aurumitalianusantara</a>
            <a href="tel:+628123456789" className="text-ivory/40 hover:text-gold text-xs font-sans transition-colors duration-300 mt-1 block">+62 812 3456 7890</a>
            <a href="https://www.google.com/maps/place/Jl.+Tjilik+Riwut+No.Km.+1,+Palangka+Raya,+Kalimantan+Tengah+73112,+Indonesia" target="_blank" rel="noopener noreferrer" className="flex items-center gap-1.5 text-ivory/40 hover:text-gold text-xs font-sans transition-colors duration-300 mt-3">
        ...
        <div className="relative border-t border-ivory/5 pt-6 flex flex-col md:flex-row justify-between items-center gap-4">
          ...
          <div className="absolute -top-[3px] left-1/2 -translate-x-1/2 -ml-6 w-1.5 h-1.5 rotate-45 bg-gold/15" />
          <p className="text-ivory/25 font-sans text-xs leading-relaxed">All activities are conducted in accordance with applicable Indonesian laws and regulations.</p>
          <p className="text-ivory/25 font-sans text-xs leading-relaxed">&copy; {new Date().getFullYear()} PT Aurum Italia Nusantara. All rights reserved.</p>
        </div>
      </div>
    </footer>);
