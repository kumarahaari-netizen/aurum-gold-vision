      ...
      <div className="relative max-w-[1400px] mx-auto px-6 md:px-12">
        ...
        >
          ...
          <div>
            ...
            <a href="mailto:info@aurumitalia.co.id" className="text-ivory/40 hover:text-gold text-xs font-sans transition-colors duration-300 mt-3 inline-block">info@aurumitalia.co.id</a>
