          ...
          >
            ...
            <form onSubmit={handleSubmit} className="flex flex-col flex-1 space-y-6">
              ...
              <div className="mt-auto">
                <motion.button
                  type="submit"
                  whileHover={{ scale: 1.02, boxShadow: "0 4px 20px hsl(225 70% 15% / 0.4)" }}
                  whileTap={{ scale: 0.98 }}
                  className="bg-navy text-gold border border-navy hover:bg-navy/80 px-8 py-3 text-xs tracking-[0.2em] transition-all duration-300 w-full"
                >
                  SUBMIT ENQUIRY
                </motion.button>
              </div>
