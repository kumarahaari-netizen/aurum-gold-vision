...
const documents = [
  { title: "Prospectus Overview", desc: "Comprehensive overview of company strategy and market positioning." },
  { title: "Investment Summary", desc: "Key investment highlights and financial structure outline." },
  { title: "Project Brief — Indonesia Gold Opportunities", desc: "Detailed briefing on current gold exploration prospects." },
  { title: "Strategic Materials Brief — Rare Earth Opportunities", desc: "Analysis of rare earth mineral market potential and projects." },
];
    ...
    <section className="py-24 md:py-32 bg-navy">
      <div className="max-w-[1400px] mx-auto px-6 md:px-12">
        ...
        >
          ...
          <h2 className="font-serif text-ivory text-3xl md:text-4xl leading-tight">Key Documents</h2>
        </motion.div>
        ...
        <div className="grid sm:grid-cols-2 gap-6 max-w-4xl mx-auto">
          {documents.map((doc, i) => (
            ...
            >
              <div className="text-gold/60 mb-4"><FileText size={28} strokeWidth={1} /></div>
              ...
              <motion.button whileHover={{ x: 4 }} className="flex items-center gap-2 text-gold/70 hover:text-gold text-xs tracking-[0.1em] transition-colors duration-300 self-start">
