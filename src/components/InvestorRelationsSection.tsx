...
const principles = [
  { icon: Shield, title: "Regulatory Compliance", desc: "Full alignment with Indonesian regulatory frameworks", image: investorCompliance },
  { icon: BarChart3, title: "Commercial Clarity", desc: "Transparent structuring of all investment pathways", image: investorClarity },
  { icon: AlertTriangle, title: "Risk-Aware Structuring", desc: "Measured approach to opportunity evaluation", image: investorRisk },
  { icon: Target, title: "Long-Term Alignment", desc: "Partnerships built for sustained value creation", image: investorAlignment },
];
          ...
          {principles.map((p, i) => (
            ...
            >
              ...
              <div className="p-6 pt-4 flex flex-col items-center">
                <motion.div whileHover={{ rotate: 10, scale: 1.2 }} className="mb-4 text-gold">
